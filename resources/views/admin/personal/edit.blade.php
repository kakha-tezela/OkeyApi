        ...
        <div class="main-bar row">
            ...
            <div class="col-sm-7 col-lg-6">
                <ol class="breadcrumb float-xs-right nav_breadcrumb_top_align">
                    ...
                    <li class="active breadcrumb-item">Add Personal</li>
                </ol>
            </div>
        </div>
    </header>
                ...
                <div class="col-xs-12">
                    <div class="card m-t-35">
                        ...
                        <div class="card-block m-t-10">
                            <div class="row">
                                <div class="col-xl-12">
                                    <form class="form-horizontal" method="post" action="{{action('Admin\PersonalsController@update',$item->id)}}">
                                        {{csrf_field()}}

                                        <input type="hidden" value="put" name="_method">
                                        <div class="col-xl-6">
                                            <h5 class="sub_title text-lg-center">მომხმარებელი</h5>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="email6" value="{{$item->name}}" class="form-control" name="name"
                                                               >
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <h5 class=" sub_title text-lg-center">პაროლის შეცვლა</h5>
                                                <div class="col-lg-3 text-lg-right">

                                                    <label for="password" class="form-control-label">ახალი პაროლი</label>
                                                </div>
                                                <div class="col-lg-8">
                                                                ...
                                                                <div class="radio">
                                                                    <label>
                                                                        <input type="radio" name="role_id"
                                                                               value="{{$role->id}}"
                                                                        @if($role->personals->contains($item->id))
                                                                            checked
                                                                            @endif>
                                                                        <span class="cr"><i
