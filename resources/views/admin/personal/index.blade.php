        ...
        <div class="main-bar row">
            ...
            <div class="col-lg-6 col-sm-8 col-xs-12">
                <ol class="breadcrumb float-xs-right  nav_breadcrumb_top_align">
                    ...
                    <li class="breadcrumb-item">
                        <a href="#">Roles & Personals</a>
                    </li>
                    <li class="active breadcrumb-item">Personals</li>
                </ol>
            </div>
        </div>
    </header>
            ...
            <div class="card">
                ...
                <div class="card-block m-t-35" id="user_body">
                    <div class="table-toolbar">
                        <div class="btn-group">
                            <a href="{{action('Admin\PersonalsController@create')}}" id="editable_table_new"
                               class=" btn btn-default">
                                Add Personal <i class="fa fa-plus"></i>
                            </a>
                        </div>
                            ...
                            <table class="table  table-striped table-bordered table-hover dataTable no-footer"
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting_asc wid-20" tabindex="0" rowspan="1" colspan="1">სახელი</th>
                                        <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">ელ-ფოსტა</th>
                                        <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">როლი</th>
...
@include('admin.includes.deletemodal',['class'=>'Personals'])
@stop
    ...
    <script>
        $(function () {
            ...
            $('#editable_table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{!! action('Admin\PersonalsController@index') !!}',
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'name', name: 'name'},
