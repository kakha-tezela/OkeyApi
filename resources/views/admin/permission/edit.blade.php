                ...
                <div class="col-xs-12">
                    <div class="card m-t-35">
                        ...
                        <div class="card-block m-t-10">
                            <div class="row">
                                <div class="col-xl-6">
                                    <form class="form-horizontal" method="post" action="{{action('Admin\PermissionController@update',$item->id)}}">
                                        {{csrf_field()}}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="email6" class="form-control" name="name" value="{{$item->name}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="description" value="{{$item->description}}" id="subject2" class="form-control" placeholder="აღწერა">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- first name-->
                                        <div class="form-group row">
                                            <div class="col-lg-9 push-lg-3">
                                                <input type="submit" class="btn btn-responsive layout_btn_prevent btn-primary" value="განახლება">
                                            </div>
                                        </div>
